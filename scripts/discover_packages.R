# Bulk discovery: scans data/content/ for blog authors with github handles,
# queries r-universe and CRAN, and writes one JSON per discovered package
# under data/packages/. Run this when seeding the dataset; for ongoing
# periodic syncs, use sync_packages.R instead.
